...
class GenerateInterpretation(object):
    ...
    def _generate_prompt(self) -> str:
        ...
        prompt += "\n\n---\n\n"
        prompt += f"Valore predetto: {round(self.pred_value)} biciclette\n"
        prompt += "Variabili rilevanti:\n"
        ...
        for var in top_vars:
            ...
            prompt += f"  • Valore osservato: {valore_mappato}\n"
    ...
    def _get_examples(self):
        ...
        with open("../jsons/examples.json") as f:
...
if __name__ == "__main__":
    ...
    shap_dict = shap_df.iloc[1].to_dict()
    pred_value = preds[1]
    ...
    for i in range(30):
        ...
        with open(f"jsons/interp_{i}.json", "w", encoding="utf-8") as f:
            json.dump({"interpretation": interpretation}, f, ensure_ascii=False, indent=4)
